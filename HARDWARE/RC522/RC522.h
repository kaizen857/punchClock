...
#define RS522_RST(x)                                                                                                                                     \
    do                                                                                                                                                   \
    {                                                                                                                                                    \
        x ? HAL_GPIO_WritePin(RC522_RST_GPIO_Port, RC522_RST_Pin, GPIO_PIN_SET) : HAL_GPIO_WritePin(RC522_RST_GPIO_Port, RC522_RST_Pin, GPIO_PIN_RESET); \
    } while (0)
#define RS522_NSS(x)                                                                                                                                 \
    do                                                                                                                                               \
    {                                                                                                                                                \
        x ? HAL_GPIO_WritePin(RC522_CS_GPIO_Port, RC522_CS_Pin, GPIO_PIN_SET) : HAL_GPIO_WritePin(RC522_CS_GPIO_Port, RC522_CS_Pin, GPIO_PIN_RESET); \
    } while (0)
/***********************************************************************************
 *								MFRC522驱动程序			        				   *
 ************************************************************************************/
